...
import com.nicht.smallspringstep05.springframework.beans.factory.BeanFactory;
...
public abstract class AbstractBeanFactory extends DefaultSingletonBeanRegisry implements BeanFactory {
    ...
    @Override
    public Object getBean(String name, Object... args) throws com.nicht.smallspringstep05.springframework.beans.BeansException {
        Object bean = getSingleton(name);
        if (bean != null) {
            return bean;
        }
