...
import com.nicht.smallspringstep08.springframework.util.ClassUtils;
...
public abstract class AbstractBeanFactory extends DefaultSingletonBeanRegisry implements ConfigurableBeanFactory {
    ...
    @Override
    public Object getBean(String name, Object... args) throws com.nicht.smallspringstep08.springframework.beans.BeansException {
        Object bean = getSingleton(name);
        if (bean != null) {
            return bean;
        }
